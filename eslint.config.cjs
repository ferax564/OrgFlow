...
module.exports = [
  ...
  { files:['server/**/*.js','desktop/**/*.cjs','scripts/**/*.cjs','tests/**/*.cjs','js/management-core.js','js/persistence.js','js/orgflow-core.js','js/seating-core.js'],
    languageOptions:{globals:readonly('module require exports __dirname __filename process Buffer console global globalThis structuredClone crypto fetch Response URL URLSearchParams TextEncoder TextDecoder Blob File AbortController setTimeout clearTimeout setInterval clearInterval setImmediate clearImmediate performance')},
